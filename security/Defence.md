...
| Framework | ID | Description | Nombre d'occurrences | Pertinence revika | État d'implémentation |
| --- | --- | --- | --- | --- | --- |
...
| NIST SP 800-53 Rev 5 | AC-3 | Access Enforcement | 138 | Code | Implémenté |
...
| NIST SP 800-53 Rev 5 | SI-7 | Software, Firmware, and Information Integrity | 130 | Code | Implémenté |
...
| NIST SP 800-53 Rev 5 | SC-7 | Boundary Protection | 94 | Code | Implémenté |
| NIST SP 800-53 Rev 5 | SC-36 | Distributed Processing and Storage | 91 | Code | Implémenté |
...
| MITRE D3FEND | D3-ITF | Inbound Traffic Filtering | 74 | Code | Implémenté |
...
| NIST SP 800-53 Rev 5 | SC-28 | Protection of Information at Rest | 51 | Code | Implémenté |
| NIST SP 800-53 Rev 5 | SC-4 | Information in Shared System Resources | 51 | Code | Implémenté |
...
| NIST SP 800-53 Rev 5 | SC-5 | Denial-of-service Protection | 41 | Code | Implémenté |
...
| NIST SP 800-53 Rev 5 | CP-10 | System Recovery and Reconstitution | 35 | Code | Implémenté |
| NIST SP 800-53 Rev 5 | SC-6 | Resource Availability | 33 | Code | Implémenté |
| MITRE D3FEND | D3-FH | File Hashing | 32 | Code | Implémenté |
| MITRE D3FEND | D3-MAN | Message Authentication | 32 | Code | Implémenté |
...
| MITRE D3FEND | D3-MENCR | Message Encryption | 29 | Code | Implémenté |
| NIST SP 800-53 Rev 5 | IA-5 | Authenticator Management | 24 | Code | Implémenté |
| NIST SP 800-53 Rev 5 | SC-8 | Transmission Confidentiality and Integrity | 22 | Code | Partiel |
...
| MITRE D3FEND | D3-NTF | Network Traffic Filtering | 18 | Code | Implémenté |
| NIST SP 800-53 Rev 5 | SC-23 | Session Authenticity | 18 | Code | Implémenté |
| NIST SP 800-53 Rev 5 | AU-10 | Non-repudiation | 17 | Code | Implémenté |
| NIST SP 800-53 Rev 5 | SA-8 | Security and Privacy Engineering Principles | 17 | Code | Implémenté |
| NIST SP 800-53 Rev 5 | AU-9 | Protection of Audit Information | 16 | Code | Partiel |
| NIST SP 800-53 Rev 5 | CP-2 | Contingency Plan | 15 | Mise en œuvre | — |
| NIST SP 800-53 Rev 5 | SC-12 | Cryptographic Key Establishment and Management | 15 | Code | Implémenté |
...
| NIST SP 800-53 Rev 5 | SI-10 | Information Input Validation | 7 | Code | Implémenté |
...
| NIST SP 800-53 Rev 5 | AU-6 | Audit Record Review, Analysis, and Reporting | 5 | Code | Partiel |
...
| NIST SP 800-53 Rev 5 | SC-13 | Cryptographic Protection | 2 | Code | Implémenté |
| NIST SP 800-53 Rev 5 | SR-11 | Component Authenticity | 2 | Code | Implémenté |
| NIST SP 800-53 Rev 5 | SR-4 | Provenance | 2 | Code | Partiel |
