...
| --- | --- | --- | --- |
| Indicator Blocking | T1562.006 | Le nœud se déconnecte pendant audits/réparations pour se soustraire à la collecte de preuves de conservation. | Journaux d'audit append-only, signés et chaînés (hash-chain) horodatant l'indisponibilité aux fenêtres critiques, exploitables a posteriori. |
