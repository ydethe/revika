...
| Impersonation | T1656 | Analogue : la fausse redondance usurpe le rôle de plusieurs dépositaires indépendants. | Défis de possession simultanés et temporellement contraints sur shards distincts, qu'un stockage partagé unique ne peut satisfaire en parallèle. |
...
| Sondes + défis de possession | T1656 | — | SI-7 |
