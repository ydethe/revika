...
| --- | --- | --- | --- |
| Impair Defenses: Indicator Blocking | T1562.006 | Le bruit massif d'événements masque les indicateurs de l'action réelle. | Rate-limiter la génération d'événements par-owner (clé sur la pubkey Ed25519) pour brider les flots destinés à noyer le journal. |
